...
##PLOTS##
#AllP#
hist(calib_data$allP, xlim=c(0,40), ylim=c(0,100), col=rgb(1,0,0,0.5), main='Histogram of All Products', xlab='All Products Derivative')
...
#dev.off()
#Test1#
hist(calib_data$test1, xlim=c(0,30), ylim=c(0,30), col=rgb(1,0,0,0.5), main='Histogram of Test 1', xlab='Test 1 Derivative')
...
#boxplot(newratios.calib$combratio, exp_data2$ratio.exp)



# Boxplot comparing calib and exp ratios
boxplot(newratios.calib$combratio, exp_data$ratio.exp, ylab="Ratio", names=c("Calibrated", "Experimental"), main="Comparison of Ratios")
